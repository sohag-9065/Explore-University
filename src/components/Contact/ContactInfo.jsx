...
const ContactInfo = () => {
    return (
        <div className="grid grid-cols-4 gap-10 max-w-[1140px]   mx-auto py-28">
            ...
            <div className="bg-[#FAFAFA] text-center">
                <h1 className=" font-medium text-2xl pt-8 pb-5 text-[#323232]">Contact Number</h1>
                <p>+ 1235 2355 98</p>
            </div>
            <div className="bg-[#FAFAFA] text-center">
                <h1 className=" font-medium text-2xl pt-8 pb-5 text-[#323232]">Email Address</h1>
                <p>info@yoursite.com</p>
            </div>
            <div className="bg-[#FAFAFA] text-center">
                <h1 className=" font-medium text-2xl pt-8 pb-5 text-[#323232]">Website</h1>
                <p>  yoursite.com </p>
            </div>
        </div>
    );
