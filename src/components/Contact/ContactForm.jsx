...
const ContactForm = () => {
    return (
        <div className=" max-w-[1140px]   mx-auto flex flex-col-reverse md:flex-row  px-6 ">
            <div className="basis-1/2 bg-[#E8EAED] flex flex-col justify-center items-center p-20">
            ...
            <div className="basis-1/2 bg-[#FAFAFA] p-12"> 
                <p className="pb-4">
