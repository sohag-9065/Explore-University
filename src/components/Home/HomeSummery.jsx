            ...
            <div className=' h-[560px]'>
                <div className=" grid grid-cols-2  max-w-[1140px] mx-auto backdrop-contrast-100 opacity-100  ">
                    <div className='relative overflow-hidden' >
                        <img src={img2} alt="" className='absolute w-[540px] h-[360px]'/> 
                        <iframe src="https://player.vimeo.com/video/45830194?h=2c5541d8bc&color=ffffff&title=0&byline=0&portrait=0&badge=0" width="540" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
